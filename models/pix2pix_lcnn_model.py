...
class Pix2Pix_lightCnn_Model(BaseModel):
    def name(self):
        return 'Pix2Pix_lightCnn_Model'
    ...
    def backward_G(self):
        ...
        self.loss_F_L1 = self.criterionL1(self.feat_fake_B, self.feat_real_B.detach()) * self.opt.lambda_F

        self.loss_G = self.loss_G_GAN + self.loss_G_L1 + self.loss_F_L1
